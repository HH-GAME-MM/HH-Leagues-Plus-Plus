...
### Changed
- HH++ battle sim removed because it is outdated and used resources in some cases. Only rena's sim is now supported: https://github.com/rena-jp/hh-battle-simulator-v4
